export const paperRollContent = {
      "SPIELREGELN": /*html*/`
            ...
            <p style="margin-bottom:0.25rem;"><strong>Rundenende:</strong> Sobald ein Spieler alle Karten aufgedeckt hat, ist die Runde zu Ende. Alle anderen Spieler dürfen noch einen Zug machen. Dann werden die Punkte aller Karten addiert. Wer die Runde beendet, sollte die geringste Punktzahl haben, sonst wird sie verdoppelt.</p>
            ...
            <p style="margin-bottom:0.25rem;">Skyjoe ist einfach zu lernen, macht Spaß für Jung und Alt und bietet bei jeder Runde neue Taktiken und Überraschungen 😺🏆</p>`,
      "EINSTELLUNGEN": /*html*/`
            <div class="settings">
